...
文本框上面有一个工具条，工具条上有两个按钮，第一个按钮点击的时候会导入第一个数据，就是上面给的数据。
第二个按钮，点击的时候导入第二个数据，这个数据是一个两个8度的音阶，8分音符每个音。


音符下方横线表示八分音符，无横线为四分音符
高8度音在音符上画点表示，低8度在音符下方发点表示。如果是8分音符点画在横线的下方。
